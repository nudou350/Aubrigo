# Email Configuration Guide - Pet SOS

This guide explains how to configure the email system for Pet SOS, which uses **Gmail SMTP** with **Nodemailer**.
...
Pet SOS uses Gmail SMTP to send transactional emails for:
...
5. Enter "Pet SOS" as the custom name
6. Click **Generate**
...
```
[EmailService] Email sent successfully to test-ong@example.com: Bem-vindo ao Pet SOS!
...
Create a separate Gmail account specifically for Pet SOS emails:
