...
export class OperatingHoursController {
  ...
  @ApiBearerAuth()
  @ApiOperation({
    summary: "Set operating hours for all days of the week (replaces existing)",
  })
  @ApiResponse({
    status: 201,
    description: "Operating hours configured successfully",
  })
  async bulkUpsertOperatingHours(
    @CurrentUser() user: any,
    @Body() dto: BulkOperatingHoursDto,
  ) {
  ...
  async createOrUpdateSettings(
    @CurrentUser() user: any,
    @Body() dto: CreateAppointmentSettingsDto,
  ) {
  ...
  @ApiBearerAuth()
  @ApiOperation({
    summary: "Get all my availability exceptions (blocks/holidays)",
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiResponse({
    status: 200,
    description: "Active exceptions retrieved successfully",
  })
  ...
  @ApiBearerAuth()
  @ApiOperation({
    summary: "Create a new availability exception (block dates)",
  })
  ...
  @ApiBearerAuth()
  @ApiOperation({
    summary: "Auto-create exceptions for all Portuguese holidays in a year",
  })
  ...
  @ApiResponse({
    status: 200,
    description: "Expired exceptions deleted successfully",
  })
