...
export class EmailService {
  ...
  async sendWelcomeEmail(email: string, name: string): Promise<boolean> {
    const html = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        <h1 style="color: #4ca8a0;">Bem-vindo ao Aubrigo!</h1>
        <p>Olá <strong>${name}</strong>,</p>
        <p>Obrigado por se registrar no Aubrigo! Estamos felizes em tê-lo conosco.</p>
  ...
  async sendPasswordResetEmail(
    ...
    const html = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        <h1 style="color: #4ca8a0;">Redefinir Senha - Aubrigo</h1>
        <p>Olá,</p>
        <p>Você solicitou a redefinição de senha da sua conta Aubrigo.</p>
  ...
  async sendAppointmentConfirmationToVisitor(
    ...
    const html = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        <h1 style="color: #4ca8a0;">Confirmação de Visita - Aubrigo</h1>
  ...
  async sendAppointmentNotificationToOng(
    ...
    const html = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        <h1 style="color: #4ca8a0;">Nova Solicitação de Visita - Aubrigo</h1>
  ...
  async sendDonationReceipt(
    ...
    const html = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        <h1 style="color: #4ca8a0;">Recibo de Doação - Aubrigo</h1>
  ...
  async sendOngRegistrationNotificationToAdmin(
    ...
    const html = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        <h1 style="color: #4ca8a0;">Nova ONG Registrada - Aubrigo</h1>
        <p>Olá Administrador,</p>
        <p>Uma nova ONG se registrou na plataforma Aubrigo e aguarda aprovação.</p>
        <div style="background: #f5f5f5; padding: 20px; border-radius: 8px; margin: 20px 0;">
  ...
  async sendWelcomeEmailToOng(
    ...
    const html = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        <h1 style="color: #4ca8a0;">Bem-vindo ao Aubrigo!</h1>
        <p>Olá <strong>${ongName}</strong>,</p>
        <p>Obrigado por se registrar no Aubrigo! Estamos felizes em tê-los conosco.</p>
  ...
  async sendOngApprovalEmail(
    ...
    const html = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        <h1 style="color: #27ae60;">🎉 Conta Aprovada - Aubrigo</h1>
        <p>Olá <strong>${ongName}</strong>,</p>
        <p>Ótimas notícias! Sua conta foi aprovada pelo nosso time administrativo.</p>
        <p>Você já pode começar a usar todos os recursos da plataforma Aubrigo:</p>
        <ul style="line-height: 1.8;">
          <li>✅ Adicionar pets para adoção</li>
          <li>✅ Gerenciar agendamentos de visitas</li>
          <li>✅ Receber doações</li>
  ...
  async sendOngRejectionEmail(
    ...
    const html = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        <h1 style="color: #e74c3c;">Atualização sobre sua Conta - Aubrigo</h1>
        <p>Olá <strong>${ongName}</strong>,</p>
        <p>Agradecemos seu interesse em fazer parte da plataforma Aubrigo.</p>
