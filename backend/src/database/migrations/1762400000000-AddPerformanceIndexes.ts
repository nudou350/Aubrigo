...
export class AddPerformanceIndexes1762400000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      CREATE INDEX IF NOT EXISTS "IDX_pets_ong_id"
      ON "pets" ("ong_id")
    `);
    ...
    await queryRunner.query(`
      CREATE INDEX IF NOT EXISTS "IDX_pets_species_status_location"
    ...
    await queryRunner.query(`
      CREATE INDEX IF NOT EXISTS "IDX_pets_ong_id_status"
    ...
    await queryRunner.query(`
      CREATE INDEX IF NOT EXISTS "IDX_favorites_visitor_email"
      ON "favorites" ("visitor_email")
    `);
    console.log("✅ Added index on favorites.visitor_email");

    await queryRunner.query(`
      CREATE INDEX IF NOT EXISTS "IDX_favorites_pet_id"
      ON "favorites" ("pet_id")
    `);
    ...
    await queryRunner.query(`
      CREATE INDEX IF NOT EXISTS "IDX_favorites_visitor_pet"
    ...
    await queryRunner.query(`
      CREATE INDEX IF NOT EXISTS "IDX_appointments_ong_id"
    ...
    await queryRunner.query(`
      CREATE INDEX IF NOT EXISTS "IDX_appointments_ong_status"
    ...
    await queryRunner.query(`
      CREATE INDEX IF NOT EXISTS "IDX_donations_ong_id"
      ON "donations" ("ong_id")
    `);
    ...
    await queryRunner.query(`
      CREATE INDEX IF NOT EXISTS "IDX_donations_ong_status_created"
      ON "donations" ("ong_id", "payment_status", "created_at" DESC)
    `);
    console.log(
      "✅ Added composite index on donations(ong_id, payment_status, created_at)",
    );

    // ONGs table additional indexes
    await queryRunner.query(`
      CREATE INDEX IF NOT EXISTS "IDX_ongs_location"
      ON "ongs" ("location")
    `);
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP INDEX IF EXISTS "IDX_ongs_location"`);
    await queryRunner.query(
      `DROP INDEX IF EXISTS "IDX_donations_ong_status_created"`,
    );
    await queryRunner.query(`DROP INDEX IF EXISTS "IDX_donations_donor_email"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "IDX_donations_created_at"`);
    await queryRunner.query(
      `DROP INDEX IF EXISTS "IDX_donations_payment_status"`,
    );
    await queryRunner.query(`DROP INDEX IF EXISTS "IDX_donations_ong_id"`);
    await queryRunner.query(
      `DROP INDEX IF EXISTS "IDX_appointments_ong_status"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(`DROP INDEX IF EXISTS "IDX_appointments_ong_id"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "IDX_favorites_visitor_pet"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "IDX_favorites_pet_id"`);
    await queryRunner.query(
      `DROP INDEX IF EXISTS "IDX_favorites_visitor_email"`,
    );
    await queryRunner.query(`DROP INDEX IF EXISTS "IDX_pets_ong_id_status"`);
    await queryRunner.query(
      `DROP INDEX IF EXISTS "IDX_pets_species_status_location"`,
    );
    await queryRunner.query(`DROP INDEX IF EXISTS "IDX_pets_ong_id"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "IDX_pets_created_at"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "IDX_pets_location"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "IDX_pets_status"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "IDX_pets_species"`);
